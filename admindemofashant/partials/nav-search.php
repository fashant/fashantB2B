                ...
                <div class="">
                    <form class="tourz-search-form tourz-top-search-form">
                        ...
                        <div class="input-field">
                            ...
                            <label for="top-select-search" class="search-hotel-type">Search Fashion Shopes, Stores....</label>
                        </div>
                        <div class="input-field" onclick="window.location.href = 'http://littlechikoosdaycare.com/list.php?f=&q=' + document.getElementById('top-select-search').value;">
