...
<div class="main_part_only_best">
    <div class="container">
        <h2>Only The Best</h2>
        <span>Poular Categories that people are shipping for right now</span>
        <div class="row">
            <div class="col-md-6">
...
//                                    echo "<li>
//                                            <div class=\"info\">
//                                                <a class=\"link\" href=\"http://littlechikoosdaycare.com/list.php?f=&categories[]=Men&brands[]=$b\">$b</a>
//                                            </div>
//                                        </li>";
//                                }
//                            }
                        ...
                        for($i = 0; $i < sizeof($men_brands); $i++){
                            ...
                            if(in_array($b, $brand_men)){
                                echo "<a class=\"link\" href=\"http://littlechikoosdaycare.com/list.php?f=&categories[]=Men&brands[]=$b\">$b</a>";
                            } else {
                                echo "<a style='color: red;' class=\"link\" href=\"http://littlechikoosdaycare.com/list.php?f=&categories[]=Men&brands[]=$b\">$b</a>";
                            }
                            echo "</div></li>";
                        }
...
//                                echo "<li>
//                                            <div class=\"info\">
//                                                <a class=\"link\" href=\"http://littlechikoosdaycare.com/list.php?f=&categories[]=Women&brands[]=$b\">$b</a>
//                                            </div>
//                                        </li>";
//                            }
//                        }
                        ...
                        for($i = 0; $i < sizeof($men_brands); $i++){
                            ...
                            if(in_array($b, $brand_women)){
                                echo "<a class=\"link\" href=\"http://littlechikoosdaycare.com/list.php?f=&categories[]=Women&brands[]=$b\">$b</a>";
                            } else {
                                echo "<a style='color: red;' class=\"link\" href=\"http://littlechikoosdaycare.com/list.php?f=&categories[]=Women&brands[]=$b\">$b</a>";
                            }
                            echo "</div></li>";
                        }
                        ?>
